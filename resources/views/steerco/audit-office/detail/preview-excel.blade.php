...
<div class="container mx-auto p-4">
    <div class="flex justify-between items-center mb-4">
        <a href="{{ route('detail-audit-office-steerco-audit-form', $id) }}" class="text-lg font-semibold flex items-center w-fit">
            ← Kembali
        </a>
        <div class="flex space-x-3">
            <a href="{{ route('audit-office-steerco-download-excel', $id) }}" class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg flex items-center">
