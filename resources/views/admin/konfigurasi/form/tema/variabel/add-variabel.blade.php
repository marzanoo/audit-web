...
<div class="container mx-auto p-4 min-h-screen">
    ...
    <form action="{{ route('add-variabel-form', $temaFormId) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <input type="file" accept="image/*" name="standar_foto[]" id="standar_foto" class="w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500" multiple onchange="previewImages(event)">
